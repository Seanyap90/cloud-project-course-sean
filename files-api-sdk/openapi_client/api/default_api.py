...
class DefaultApi:
    ...
    @validate_arguments
    def upload_file_v1_file_file_path_put(
    ...
    @validate_arguments
    def upload_file_v1_file_file_path_put_with_http_info(
        self, file_path: StrictStr, file: Union[StrictBytes, StrictStr], **kwargs
    ) -> ApiResponse:  # noqa: E501
        """Upload File  # noqa: E501
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method upload_file_v1_file_file_path_put" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
