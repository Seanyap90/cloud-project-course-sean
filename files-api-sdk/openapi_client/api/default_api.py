...
class DefaultApi:
    ...
    @validate_arguments
    def upload_file_v1_file_file_path_put(self, file_path : StrictStr, file : Union[StrictBytes, StrictStr], **kwargs) -> PutFileResponse:  # noqa: E501
        ...
        >>> thread = api.upload_file_v1_file_file_path_put(file_path, file, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the upload_file_v1_file_file_path_put_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.upload_file_v1_file_file_path_put_with_http_info(file_path, file, **kwargs)  # noqa: E501

    @validate_arguments
    def upload_file_v1_file_file_path_put_with_http_info(self, file_path : StrictStr, file : Union[StrictBytes, StrictStr], **kwargs) -> ApiResponse:  # noqa: E501
        """Upload File  # noqa: E501
        ...
        >>> thread = api.upload_file_v1_file_file_path_put_with_http_info(file_path, file, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method upload_file_v1_file_file_path_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
